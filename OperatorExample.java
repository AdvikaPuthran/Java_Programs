class OperatorExample
{
	...
	{
		int num1=6;
		System.out.println(num1++);//post increment 6
		System.out.println(++num1);//pre increment 8
		System.out.println(num1--);//post decrement 8
		System.out.println(num1++);//post increment 7
		System.out.println(--num1);//pre decrement 7
		System.out.println(num1++);//post increment 7
